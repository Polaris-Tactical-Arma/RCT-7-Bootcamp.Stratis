class CfgServerInfoMenu
{
   ...
   class menuItems
   {
      ...
      {
         menuName = "General";
         title = "<t color='#ffffff'>Welcome to the official RCT-7 bootcamp!</t>";
         content[] = {
            ...
            <br />
            <br />The bootcamp consists of 10 sections;
            ...
            <br /><t size='.5'></t>6. Anti-Tank Usage
            <br /><t size='.5'></t>7. Anti-Air Usage
            <br /><t size='.5'></t>8. Formations
            <br /><t size='.5'></t>9. Bounding
            <br /><t size='.5'></t>10. ACE Medical
            <br />
