...
while { _count isNotEqualTo _index } do {
	...
	[[_mainTask, _throwGrenadeTaskId], "Throw your grenade", "Identify the yellow target and left click to throw the grenade at them.\nUse the white indictator to identify the trajectory - a red circle indicates the grenade will bounce at this point.", "destroy"] call RCT7Bootcamp_fnc_taskCreate;
